...
*!*			   ??" "
*!*			   ??IIF(!ISNULL(.cells(n,1).value),CHRTRAN(.cells(n,1).value,CHRTRAN(.cells(n,1).value,alfab,"")," "),"gol")
*!*			   **??CHRTRAN(.cells(n,1).value,CHRTRAN(.cells(n,1).value,alfab,"")," ")
*!*			   
*!*			   ??" umC/palet="
*!*			   
*!*			   ??.cells(n,6).value
